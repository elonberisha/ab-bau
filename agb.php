...
$agbContent = $legal['agb_content'] ?? '<p class="text-center py-10">Përmbajtja nuk është disponueshme.</p>';
?>
<!DOCTYPE html>
<html lang="de">
<head>
    ...
    <meta name="description" content="AGB - AB Bau">
    <title>AGB - AB Bau | Bau und Fliesen GmbH</title>
    ...
    <section class="relative pt-32 sm:pt-36 lg:pt-40 pb-16 sm:pb-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
            <div class="text-center text-white">
                ...
                <p class="text-xl sm:text-2xl text-white/90 max-w-3xl mx-auto">AGB - AB Bau</p>
            </div>
        </div>
    </section>
